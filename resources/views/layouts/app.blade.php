                    ...
                    <div class="z-20">
                        <div class="avatar online w-24 h-24 fixed bottom-10 right-10 hover:cursor-pointer">
                            <div class="rounded-full">
                                <label for="my-drawer" class="drawer-button hover:cursor-pointer"><img
                                        src="https://cdn.dribbble.com/userupload/13167768/file/original-08e29755d8f12fdb9ef53d5b88bfeef0.jpg?resize=1024x768" /></label>
