        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-slate-950 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-white">
                    ...
                    <p><strong>Créé le:</strong> {{ \Carbon\Carbon::parse($service->created_at)->format('d/m/Y H:i') }}</p>
                    <p><strong>Edité le:</strong> {{ \Carbon\Carbon::parse($service->updated_at)->format('d/m/Y H:i') }}</p>
